...
(() => {
    ...
    if (hostWin.__DabaoAgentHeaderBadgeTimer) {
        hostWin.clearInterval(hostWin.__DabaoAgentHeaderBadgeTimer);
    }
    hostWin.__DabaoAgentHeaderBadgeTimer = hostWin.setInterval(ensureBadge, 500);
...
def init_session_state():
    for key, value in {
        'agent_name': 'DabaoAgent', 'streaming': False, 'stopping': False, 'display_queue': None,
